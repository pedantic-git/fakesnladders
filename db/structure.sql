...
CREATE TABLE "markov_chains" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "current" varchar(255), "next" varchar(255), "probability" float, "topic_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "email" varchar(255), "provider" varchar(255), "uid" varchar(255), "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "position" integer);
